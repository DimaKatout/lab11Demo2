var names = [
  ...
  rightImage.setAttribute('src',`images/${names[1]}.jpg`);
  ...
  //zay ma kona ne3mel al js abel

  Goat.all =[];
  
  //(3_2) instantiate objects for all the goats one shot
  //3am ba3mel instance men kol goat
  ...
  function handleClickOnGoat(event) {
    if(totalClicks <5 ) {
          //eza kabaset bara alsowar ma ra7 ye3mel render ..
